...
export function Abacus({
  ...
  return (
    ...
    >
      <div className="inline-block rounded-md border-[clamp(0.375rem,1.5vw,0.5rem)] border-sky-950 bg-sky-100 p-[clamp(0.5rem,2vw,1rem)] shadow-2xl shadow-sky-950/20">
        <div className="relative isolate grid auto-cols-[var(--rod-w)] grid-flow-col gap-[clamp(0.25rem,1vw,0.5rem)]">
          <div
            aria-hidden="true"
            className="absolute top-[var(--bar-top)] right-0 left-0 z-20 h-[var(--bar-h)] rounded-full bg-sky-950 shadow-md"
          />
